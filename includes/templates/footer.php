    ...
    <footer class="pt-5">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <img src="img/logo-prestago.png" class="mx-auto d-block" alt="Logo de PrestaGO">
                </div>
                <div class="col-md-4">
                    <p class="text-center m-0 p-2">info@prestagoperu.com</p>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <ul class="nav justify-content-center redes-nav">
        ...
        <div class="barra-footer">
            <p>Sitio web creado por <a>Scrabble Marketing</a></p>
        </div>
    </footer>
